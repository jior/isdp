...
insert into SYS_APPLICATION (id, name, appdesc, url, sort, showmenu, nodeid, code) values (62, '分级部门管理', '', '/mx/branch/department', 2, 1, 62, null);
insert into SYS_APPLICATION (id, name, appdesc, url, sort, showmenu, nodeid, code) values (63, '分级权限管理', '', '/mx/branch/department/frame', 3, 1, 63, null);
