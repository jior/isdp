...
import com.glaf.bpmn.util.FlowStationJsonFactory;

@Entity
@Table(name = "flow_station")
public class FlowStationEntity implements Serializable, JSONable {
	...
	public FlowStationEntity jsonToObject(JSONObject jsonObject) {
