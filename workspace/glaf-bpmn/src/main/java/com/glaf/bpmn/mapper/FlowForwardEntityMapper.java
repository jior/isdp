...
public interface FlowForwardEntityMapper {
	...
	int getFlowForwardEntityCountByQueryCriteria(FlowForwardQuery query);

	List<FlowForwardEntity> getFlowForwardEntities(Map<String, Object> parameter);

	List<FlowForwardEntity> getFlowForwardEntitiesByQueryCriteria(
			FlowForwardQuery query);

	void insertFlowForwardEntity(FlowForwardEntity model);

	void updateFlowForwardEntity(FlowForwardEntity model);
