...
public interface MessageService {
	 ...
	 * @return
	 */
	PageResult getReceiveList(String userId, Map params, int pageNo, int pageSize);
	 ...
	 * @return
	 */
	PageResult getNoReadList(String userId, Map params, int pageNo, int pageSize);
	 ...
	 * @return
	 */
	PageResult getSendedList(String userId, Map params, int pageNo, int pageSize);
}