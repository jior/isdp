 ...
 */
package com.glaf.base.ui.models;
...
public class DataSourceRequest {
	...
	public static class GroupDescriptor extends
			DataSourceRequest.SortDescriptor {
		private List<DataSourceRequest.AggregateDescriptor> aggregates;

		public GroupDescriptor() {
			this.aggregates = new ArrayList<DataSourceRequest.AggregateDescriptor>();
		}

		public List<DataSourceRequest.AggregateDescriptor> getAggregates() {
