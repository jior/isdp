...
public class MailRecAttQuery extends DataQuery {
	...
	public MailRecAttQuery topid(String topid) {
		if (topid == null) {
	...
	public MailRecAttQuery topidLike(String topidLike) {
		if (topidLike == null) {
			throw new RuntimeException("topid is null");
		}
		this.topidLike = topidLike;
	...
	public MailRecAttQuery topids(List<String> topids) {
		if (topids == null) {
	...
	public MailRecAttQuery fileName(String fileName) {
		if (fileName == null) {
	...
	public MailRecAttQuery fileNameLike(String fileNameLike) {
	...
	public MailRecAttQuery ctimeGreaterThanOrEqual(Date ctimeGreaterThanOrEqual) {
	...
	public MailRecAttQuery ctimeLessThanOrEqual(Date ctimeLessThanOrEqual) {
	...
	public MailRecAttQuery filesizeGreaterThanOrEqual(
	...
	public MailRecAttQuery filesizeLessThanOrEqual(
