...
public class CellMenuListQuery extends DataQuery {
	...
	public CellMenuListQuery topid(String topid) {
		if (topid == null) {
	...
	public CellMenuListQuery topidLike(String topidLike) {
		if (topidLike == null) {
			throw new RuntimeException("topid is null");
		}
		this.topidLike = topidLike;
	...
	public CellMenuListQuery topids(List<String> topids) {
		if (topids == null) {
	...
	public CellMenuListQuery indexId(Integer indexId) {
		if (indexId == null) {
	...
	public CellMenuListQuery indexIdGreaterThanOrEqual(
	...
	public CellMenuListQuery indexIdLessThanOrEqual(
	...
	public CellMenuListQuery indexIds(List<Integer> indexIds) {
		if (indexIds == null) {
