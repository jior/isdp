...
public class FiledotJsonFactory {
	...
	public static IsdpFiledot jsonToObject(JSONObject jsonObject) {
		IsdpFiledot model = new IsdpFiledot();
	...
	public static JSONObject toJsonObject(IsdpFiledot model) {
	...
	public static ObjectNode toObjectNode(IsdpFiledot model) {
	...
	public static JSONArray listToArray(java.util.List<IsdpFiledot> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (IsdpFiledot model : list) {
	...
	public static java.util.List<IsdpFiledot> arrayToList(JSONArray array) {
		java.util.List<IsdpFiledot> list = new java.util.ArrayList<IsdpFiledot>();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			IsdpFiledot model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}
