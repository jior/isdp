...
public class PfileJsonFactory {
	...
	public static IsdpPfile jsonToObject(JSONObject jsonObject) {
		IsdpPfile model = new IsdpPfile();
	...
	public static JSONObject toJsonObject(IsdpPfile model) {
	...
	public static ObjectNode toObjectNode(IsdpPfile model) {
	...
	public static JSONArray listToArray(java.util.List<IsdpPfile> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (IsdpPfile model : list) {
	...
	public static java.util.List<IsdpPfile> arrayToList(JSONArray array) {
		java.util.List<IsdpPfile> list = new java.util.ArrayList<IsdpPfile>();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			IsdpPfile model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}
