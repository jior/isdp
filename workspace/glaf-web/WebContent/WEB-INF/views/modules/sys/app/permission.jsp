...
<script type="text/javascript">
     ...
     function saveUserRole(actorId, roleId){
		 ...
		 jQuery.ajax({
				   type: "POST",
				   url: '<%=request.getContextPath()%>/mx/sys/user/saveUserRole?actorId='+actorId+'&roleId='+roleId+'&operation='+operation,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
				   },
		...
		<table width="95%" height="80" border="0" cellspacing="1" cellpadding="0" class="mainTable">
			...
			<td colspan="10" class="list-title">
			  <table width="100%" cellspacing="0" cellpadding="0">
			   <tr>
				<td align="left">
				<font color="#0066ff">
				<b>角色：<%=role.getName()%>[<%=role.getCode() != null ? role.getCode() :""%>]</b>
				</font>
				</td>
			   </tr>
			  </table>
		  ...
		  <tr>
			...
			<td class="weekend" align="left" height="25" width="180">
			  ...
			  onclick="javascript:saveUserRole('<%=user.getActorId()%>','<%=role.getId()%>')"  >
				<%				 				      
