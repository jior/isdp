  ...
  <tr> 
    ...
    <th width="995" valign="top"><div align="left"> 
        ...
        <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td>
			  <jsp:include page="/mx/sys/application/showNavMenu" flush="true"> 
          ...
          <tr> 
            <td colspan="4" valign="top" class="tdborder"> <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td><iframe id="mainFrame" name="mainFrame" src="department/showFrame" width="100%" frameborder="0" height="370"></iframe></td>
                </tr>
              </table></td>
          </tr>
        </table>
