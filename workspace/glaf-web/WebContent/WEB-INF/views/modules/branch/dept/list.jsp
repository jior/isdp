...
<script type="text/javascript">
   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				striped: true,
				collapsible:true,
				url:'<%=request.getContextPath()%>/mx/branch/department/json',
				sortName: 'id',
				sortOrder: 'desc',
				remoteSort: false,
				singleSelect:true,
	...
	function deptRoles(){
	    ...
	    if (selected ){
		  //location.href="<%=request.getContextPath()%>/branch/department.do?method=edit&rowId="+selected.id;
		  var link = "<%=request.getContextPath()%>/mx/branch/deptRole/showList?parent="+selected.id;
	...
	function deptUsers(){
	    ...
	    if (selected ){
		  //location.href="<%=request.getContextPath()%>/branch/department.do?method=edit&rowId="+selected.id;
		  var link = "<%=request.getContextPath()%>/mx/branch/user?parent="+selected.id;
