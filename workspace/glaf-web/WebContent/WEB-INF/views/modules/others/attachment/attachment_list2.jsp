...
%>
<TR>
  <TD height="20" class="td-text"><a href="<%=request.getContextPath()%>/mx/others/attachment/download?referType=<%=referType%>&referId=<%=referId%>&id=<%=bean.getId()%>"><%=bean.getName()%></a></TD>
