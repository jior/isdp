...
function modify(){
  ...
  var url="mymenu/prepareModify?id="+id;
  var width=450;
  var height=350;
  var scroll="no";
  openWindow(url, width, height, scroll);
...
function del(){
  ...
  if(confirmDelete(form)){
    form.target="_blank";
    form.action="mymenu/batchDelete";
	form.submit();
  }
}
...
<html:form action="/mx/workspace/mymenu/batchDelete" method="post" target="_self"> 
