...
<script type="text/javascript">
    ...
    var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/rs/treeProjectInfo/treeJson?strfuntion=${strfuntion}"
			},
			check: {
				enable: true,
				chkStyle: "radio",
	...
	function chooseMyFormData(){
        ...
        for(var i=0; i<selectedNodes.length; i++){ 
			...
			if(selectedNodes[i].indexId){
			  sx += selectedNodes[i].indexId; 
              sx_name += selectedNodes[i].indexName; 
			}
        }  
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:true,border:true" style="height:40px"> 
	...
	<span class="x_content_title">关联WBS</span>
