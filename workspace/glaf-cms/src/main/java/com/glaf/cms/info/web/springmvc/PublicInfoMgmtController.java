	...
	public byte[] completeTask(HttpServletRequest request, ModelMap modelMap) {
		...
		if (publicInfo != null && publicInfo.getProcessInstanceId() != null
			...
			TaskItem taskItem = ProcessContainer.getContainer()
					.getTaskItemByProcessInstanceId(
							publicInfo.getProcessInstanceId(), actorId);
			...
			if (taskItem != null) {
				...
				if (StringUtils.isNotEmpty(isAgree)) {
					...
					if (StringUtils.equalsIgnoreCase(isAgree, "true")) {
						DataField approve = new DataField();
						approve.setName("approve");
						approve.setValue(true);
						datafields.add(approve);
					} else {
						DataField approve = new DataField();
						approve.setName("approve");
				...
				ctx.setTaskId(taskItem.getTaskInstanceId());
		...
		logger.debug("publicInfo:" + publicInfo);
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		if (StringUtils.equals(x_method, "submit")) {
			if (publicInfo != null && publicInfo.getProcessInstanceId() != null) {
				...
				TaskItem taskItem = container.getTaskItem(actorId,
	...
	public byte[] json(HttpServletRequest request, ModelMap modelMap)
		...
		if (StringUtils.equals(workedProcessFlag, "PD")) {
			List<String> processInstanceIds = container
					.getRunningProcessInstanceIds(user.getActorId());
	...
	public byte[] startProcess(HttpServletRequest request, ModelMap modelMap) {
		...
		if (publicInfo != null) {
			...
			if (StringUtils.isNotEmpty(processName)) {
				ProcessContext ctx = new ProcessContext();
				ctx.setBusinessKey(publicInfo.getId());
				ctx.setActorId(actorId);
