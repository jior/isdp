...
/**
 * Adds dms configuration files to a Configuration
 */
public class DmsConfiguration extends Configuration {

	protected static final Log LOG = LogFactory.getLog(DmsConfiguration.class);

	private DmsConfiguration() {
		super();
		addCustomResources(this);
	}

	public static Configuration addCustomResources(Configuration conf) {
		conf.addResource("glaf-dms-default.xml");
		conf.addResource("glaf-dms-site.xml");
		return conf;
	}
	 ...
	 * @return a Configuration created with the glaf-dms-*.xml files plus the
	 *         given configuration.
	 */
